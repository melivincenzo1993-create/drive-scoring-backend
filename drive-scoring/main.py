...
def home():
    ...
    <body>
        <div class="container">
            ...
            <p class="subtitle">Seleziona il profilo corretto e calcola l'affidabilità finanziaria.</p>
    ...
    if "text/html" in accept_header:
        ...
        <head>
            ...
            <style>
                ...
                .progress-bar {{ background-color: {colore_
