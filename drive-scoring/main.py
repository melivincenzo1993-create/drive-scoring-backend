...
async def score_premium(
    ...
    # CRITERIO 2: Limiti di Indebitamento Rigidi (Soglie del 30% e 45%)
    ...
    # CRITERIO 3: Reddito Minimo di Sussistenza
    ...
    # CRITERIO 4: Vincoli sul Profilo Professionale
    ...
    # CRITERIO 5: Vincoli Anagrafici Rigidi
    ...
    # =========================================================================
    # 3. GENERAZIONE PDF CON INTERFACCIA PREMIUM EDITORIALE MINIMAL
    # =========================================================================
    buffer = io.BytesIO()
    ...
    # Blocco 1: Intestazione Istituzionale
    header_data = [
        [
